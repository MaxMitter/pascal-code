PROGRAM Kaffeeautomat;
  ...
  BEGIN (* CalculateChange *)
    ...
    if credit < coffePrize then BEGIN
      WriteLn('Not enough credit. Please input at least ', (coffePrize / 100):1:2, ' EUR.');
      CalculateChange := coinsInput;
    end else BEGIN
      credit := credit - coffePrize; (* Removes the prize for one coffe from the total credits *)
  ...
  BEGIN (* CoffeeButtonPressed *)
    ...
    if totalCredit <> coffePrize then BEGIN
