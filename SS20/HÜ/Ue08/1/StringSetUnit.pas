...
INTERFACE
  ...
  TYPE
    ...
    FUNCTION Union(s1, s2: StringSet): StringSet;
    FUNCTION Intersect(s1, s2: StringSet): StringSet;
    FUNCTION Difference(s1, s2: StringSet): StringSet;
